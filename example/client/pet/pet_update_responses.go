...
func (o *PetUpdateCreated) Error() string {
	return fmt.Sprintf("[PUT /pets/{petId}][%d] petUpdateCreated  %+v", 201, o.Payload)
}
...
func (o *PetUpdateBadRequest) Error() string {
	return fmt.Sprintf("[PUT /pets/{petId}][%d] petUpdateBadRequest ", 400)
}
...
func (o *PetUpdateNotFound) Error() string {
	return fmt.Sprintf("[PUT /pets/{petId}][%d] petUpdateNotFound ", 404)
}
...
func (o *PetUpdateMethodNotAllowed) Error() string {
	return fmt.Sprintf("[PUT /pets/{petId}][%d] petUpdateMethodNotAllowed ", 405)
}

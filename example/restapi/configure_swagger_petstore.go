...
func Handler(c Config) (http.Handler, error) {
	...
	api.StoreOrderDeleteHandler = store.OrderDeleteHandlerFunc(func(params store.OrderDeleteParams) middleware.Responder {
		ctx := params.HTTPRequest.Context()
		return c.StoreAPI.OrderDelete(ctx, params)
	})
	api.StoreOrderGetHandler = store.OrderGetHandlerFunc(func(params store.OrderGetParams) middleware.Responder {
		ctx := params.HTTPRequest.Context()
